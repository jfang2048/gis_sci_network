...
EXACT_DESCRIPTIONS: dict[str, str] = {
    ...
    "international_collaboration_share": "International Works divided by all included Works.",
    "cross_region_collaboration_share": "Cross-region Works divided by all included Works.",
